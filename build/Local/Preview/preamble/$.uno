...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("131.179.51.19"), 12124)}, "/Users/jeehaesong/Documents/likelion/spring17/hikr/hikr/hikr.unoproj", GetBundle, new string[] { })
{
